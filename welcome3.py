...
def open_login_window():
    ...
    # Créer une frame pour contenir les champs et boutons au-dessus de l'image sans fond blanc
    frame_login = tk.Frame(login_window)  # Supprime "bg='white'" et "bd=2"
...
def open_register_window():
    ...
    # Créer une frame pour contenir les champs et boutons au-dessus de l'image sans fond blanc
    frame_register = tk.Frame(register_window)  # Supprime "bg='white'" et "bd=2"
...
# Créer une frame pour contenir les éléments au-dessus de l'image sans fond blanc
frame = tk.Frame(root)  # Supprime "bg='white'" et "bd=2"
frame.place(relx=0.5, rely=0.5, anchor="center")

# Bouton pour s'identifier
login_button = tk.Button(frame, text="S'identifier", font=("Arial", 14), command=open_login_window)
login_button.grid(row=0, column=0, columnspan=2, pady=20)
